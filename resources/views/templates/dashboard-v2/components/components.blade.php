...
<head>
    ...
    <title>Admin-v2 - Components</title>
...
<body>
    ...
    <div id="content">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="text-primary font-weight-bold">Components</h3>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            Add .btn.round for rounded buttons and .ripple for ripple effect
                        </div>
                        <div class="card-body">
                            <a href="#" class="btn btn-primary btn-round ripple">.btn-round</a>
                            <a href="#" class="btn btn-secondary btn-round ripple">.btn-round</a>
                            <a href="#" class="btn btn-light btn-round ripple">.btn-round</a>
                        </div>
                    </div>
                </div><br>
            </div><br>
            <div class="row">
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <a href="#" class="btn btn-primary ripple btn-block">.btn-block</a>
                        </div>
                    </div>
                    <br>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            <a href="#" class="btn btn-secondary btn-round btn-block">.btn-block</a>
                        </div>
                    </div>
                    <br>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <h4 class="title text-montserrat">.card</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <h4 class="title text-montserrat">.bg-primary-color</h4>
                                </div>
                            </div>
                        </div>
                    </div><br>
                ...
                <div class="col-12 col-md-6 col-xl-6">
                    <div class="card bg-secondary-color">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <h4 class="title text-montserrat">.bg-secondary-color</h4>
                                </div>
                            </div>
                        </div>
                    </div><br>
            ...
            <div class="row" id="modals">
                <div class="col-12">
                    <hr>
                    <h3 class="text-primary">Modals</h3>
                </div>
                <div class="col-md-6">
            ...
            <div class="row" id="navbars">
                <div class="col-12">
                    <hr>
                    <h3 class="text-primary">Navbars</h3>
                </div>
                <div class="col-md-12">
