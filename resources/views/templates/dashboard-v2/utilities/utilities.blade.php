...
<head>
    ...
    <title>Admin-v2 - Utilities</title>
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container">
                ...
                <a href="/templates/themes" class="nav-item nav-link ripple text-montserrat font-weight-bold">
                    Colorffy</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="text-primary font-weight-bold">Utilities</h3>
                </div>
            ...
            <div class="row" id="borders">
                <div class="col-12">
                    <hr>
                    <h3 class="text-primary text-montserrat">Borders</h3>
                </div>
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="row" id="colors">
                <div class="col-12">
                    <hr>
                    <h3 class="text-primary text-montserrat">Colors</h3>
                </div>
            ...
            <div class="row" id="typography">
                <div class="col-12">
                    <hr>
                    <h3 class="text-primary text-montserrat">Typography</h3>
                </div>
                <div class="col-6 col-md-6">
                    <div class="card">
                        <div class="card-body">
                ...
                <div class="col-6 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="text-black-white">.text-black-white</h3>
                            <h3 class="text-roboto">.text-roboto</h3>
                            <h3 class="text-montserrat">.text-montserrat</h3><br>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold text-montserrat" id="exampleModalLabel">Change
                                Password
                            </h5>
            ...
            <div class="modal fade" id="notificationModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title font-weight-bold text-montserrat" id="exampleModalLabel">Activities
                                <span class="badge badge-secondary">0 Activities left</span></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
