...
<div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="text-poppins text-indigo">Pricing</h3><br>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <div class="card card-form">
                    <div class="card-body text-left">
                        ...
                        <h3 class="text-poppins  color-indigo text-center">$0 USD</h3>
            ...
            <div class="col-sm-6">
                <div class="card card-form">
                    <div class="card-body text-left">
                        ...
                        <h3 class="text-poppins text-indigo text-center">$1.99 USD</h3>
