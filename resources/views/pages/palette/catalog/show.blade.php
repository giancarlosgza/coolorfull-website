...
<div class="container btn-return">
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-link ripple ripple-dark" href="/palettes/catalog"><i class="material-icons">arrow_back</i> Go back</a>
            <br>
        </div>
    </div>
</div>
<ul class="nav justify-content-center">
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy" data-clipboard-text="{{$palette->color_1}}">
            <i class="fas fa-circle" style="color: {{$palette->color_1}};"></i> {{$palette->color_1}}
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy" data-clipboard-text="{{$palette->color_2}}">
            <i class="fas fa-circle" style="color: {{$palette->color_2}};"></i> {{$palette->color_2}}
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy" data-clipboard-text="{{$palette->color_3}}">
            <i class="fas fa-circle" style="color: {{$palette->color_3}};"></i> {{$palette->color_3}}
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy" data-clipboard-text="{{$palette->color_4}}">
            <i class="fas fa-circle" style="color: {{$palette->color_4}};"></i> {{$palette->color_4}}
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy" data-clipboard-text="{{$palette->color_5}}">
...
<div class="container">
    ...
    <hr>
    <h4 class="font-weight-bold">Color Blindness</h4>
    <h6><strong>Note:</strong> The color blindness filters doesn't work on some browsers</h6>
    <div class="card card-outline mt-3">
        <div class="card-body">
            <div class="section-color-blindness">
                <!--COLOR BLINDNESS TABS-->
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"> <li class="nav-item"> <a class="nav-link active" id="pills-color1-tab" data-toggle="pill" href="#pills-color1" role="tab" aria-controls="pills-color1" aria-selected="true">{{$palette->color_1}}</a> </li> <li class="nav-item"> <a class="nav-link" id="pills-color2-tab" data-toggle="pill" href="#pills-color2" role="tab" aria-controls="pills-color2" aria-selected="false">{{$palette->color_2}}</a> </li> <li class="nav-item"> <a class="nav-link" id="pills-color3-tab" data-toggle="pill" href="#pills-color3" role="tab" aria-controls="pills-color3" aria-selected="false">{{$palette->color_3}}</a> </li> <li class="nav-item"> <a class="nav-link" id="pills-color4-tab" data-toggle="pill" href="#pills-color4" role="tab" aria-controls="pills-color4" aria-selected="false">{{$palette->color_4}}</a> </li> <li class="nav-item"> <a class="nav-link" id="pills-color5-tab" data-toggle="pill" href="#pills-color5" role="tab" aria-controls="pills-color5" aria-selected="false">{{$palette->color_5}}</a> </li> </ul> <div class="tab-content" id="pills-tabContent"> <div class="tab-pane fade show active" id="pills-color1" role="tabpanel" aria-labelledby="pills-color1-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body"style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_1}}"> </div> </div> </section> </div> </div> </div> <div class="tab-pane fade" id="pills-color2" role="tabpanel" aria-labelledby="pills-color2-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body"style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_2}}"> </div> </div> </section> </div> </div> </div> <div class="tab-pane fade" id="pills-color3" role="tabpanel" aria-labelledby="pills-color3-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body"style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_3}}"> </div> </div> </section> </div> </div> </div> <div class="tab-pane fade" id="pills-color4" role="tabpanel" aria-labelledby="pills-color4-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body"style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_4}}"> </div> </div> </section> </div> </div> </div> <div class="tab-pane fade" id="pills-color5" role="tabpanel" aria-labelledby="pills-color5-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body"style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body" style="background-color:{{$palette->color_5}}"> </div> </div> </section> </div> </div> </div> </div>
            </div>
        </div>
    </div>
    <hr><!--ICONS WITH COLOR PALETTES-->
    <h4 class="font-weight-bold">Icons Preview</h4>
        <div class="card card-outline">
            <div class="card-body">           
