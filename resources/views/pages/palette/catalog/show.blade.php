...
<style type="text/css">
    .st0{fill:{{$palette->color_1}};stroke:{{$palette->color_2}};stroke-width:2;stroke-miterlimit:10;}
    .st1{fill:{{$palette->color_2}};}
    .st2{fill:{{$palette->color_3}};}
    .st3{fill:{{$palette->color_4}};}
    .st4{fill:{{$palette->color_5}};}
    .st5{fill:{{$palette->color_1}};stroke:{{$palette->color_1}};stroke-width:2;stroke-miterlimit:10;}
</style>
