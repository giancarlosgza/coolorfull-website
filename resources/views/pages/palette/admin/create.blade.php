                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/palettes/new" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('color_3') ? ' is-invalid' : '' }}" id="color_3" name="color_3" placeholder="#5421rs">
                        </div>

                        <div class="form-group">
                            <label for="color_4">Color 4:</label>
                            <input type="text" class="form-control{{ $errors->has('color_4') ? ' is-invalid' : '' }}" id="color_4" name="color_4" placeholder="#000000">
                        </div>
                        <!--
