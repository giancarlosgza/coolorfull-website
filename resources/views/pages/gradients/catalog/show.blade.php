    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="card shadow-medium">
                <div class="card-body">
                   <h4 class="text-center text-montserrat uppercase">{{$gradient->name}}</h4>
...
<div class="container">
    ...
    <h3 class="text-montserrat">Preview UI Components</h3>
    <div class="card shadow-medium">
        <div class="card-body">  
            <!--UI ELEMENTS-->
            <div class="row"> <div class="col-sm-12 col-md-6"><br> <h3>Buttons</h3> <div class="btn btn-outline-light btn-sm @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> <div class="btn btn-outline-light @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> <div class="btn btn-outline-light btn-lg @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> </div> <div class="col-sm-12 col-md-6"><br> <h3>Badges</h3> <span class="badge badge-light uppercase @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</span> <span class="badge badge-dark uppercase @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</span> </div> <div class="col-sm-12 col-md-6"><br> <h3>Navbar text-black</h3> <nav class="navbar navbar-expand-lg navbar-dark @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <a class="navbar-brand text-dark text-montserrat">Colorffy</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav2" aria-controls="navbarNav2" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarNav2"> <ul class="navbar-nav"> <li class="nav-item"> <a class="nav-link text-dark">Home</a> </li> <li class="nav-item"> <a class="nav-link text-dark">Gradients</a> </li> </ul> </div> </nav> </div> <div class="col-sm-12 col-md-6"><br> <h3>Navbar text-white</h3> <nav class="navbar navbar-expand-lg navbar-dark bg-dark @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <a class="navbar-brand text-white logo">Colorffy</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav3" aria-controls="navbarNav3" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarNav3"> <ul class="navbar-nav"> <li class="nav-item"> <a class="nav-link">Home</a> </li> <li class="nav-item"> <a class="nav-link">Gradients</a> </li> </ul> </div> </nav> </div></div><div class="row"> <div class="col-sm-12 col-md-6"><br> <h3>Card text-black</h3> <div class="card text-body shadow-medium @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <div class="card-body"> <h3 class="card-title"><i class="far fa-clock"></i> 9:30 AM</h3> <p class="card-text bold">Work Meeting</p> </div> </div> </div> <div class="col-sm-12 col-md-6"><br> <h3>Card text-white</h3> <div class="card text-white shadow-medium @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <div class="card-body"> <h3 class="card-title"><i class="far fa-clock"></i> 6:30 PM</h3> <p class="card-text bold">Pizza time!</p> </div> </div> </div></div>
        </div>
    </div>
    ...
    <div class="card shadow-medium">
        <div class="card-body">
            ...
            <div class="alert-device">
                <h6>Sorry, the color blindness filters are not available on your browser 😔. But they are available on PC 😁</h6>
            </div>
        </div>
    </div>
    <hr>
    ...
    <!-- Modal -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"> <div class="modal-dialog" role="document"> <div class="modal-content"> <div class="modal-header"> <h5 class="modal-title text-montserrat uppercase" id="exampleModalLabel">CSS: {{$gradient->name}}</h5> <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button> </div> <div class="modal-body"> <div class="table-responsive"> <table class="table table-hover"> <thead> <tr class="h6-responsive"> <th scope="col">ORIENTATION</th> <th scope="col">CSS</th> <th>ACTION</th> </tr> </thead> <tbody> <tr class="h6-responsive"> <th scope="row">➡️</th> <td><code>background: linear-gradient(to right, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);</code></td> <td><button type="button" class="btn btn-primary shadow-medium " data-dismiss="modal" onclick="copyColor(this)" data-toggle="tooltip" title="Click to copy" data-clipboard-text="background: linear-gradient(to right, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);">Copy</button></td> </tr> <tr class="h6-responsive"> <th scope="row">⬅️</th> <td><code>background: linear-gradient(to left, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);</code></td> <td><button type="button" class="btn btn-primary shadow-medium " data-dismiss="modal" onclick="copyColor(this)" data-toggle="tooltip" title="Click to copy" data-clipboard-text="background: linear-gradient(to left, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);">Copy</button></td> </tr> <tr class="h6-responsive"> <th scope="row">⬇️</th> <td><code>background: linear-gradient(to bottom, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);</code></td> <td><button type="button" class="btn btn-primary shadow-medium " data-dismiss="modal" onclick="copyColor(this)" data-toggle="tooltip" title="Click to copy" data-clipboard-text="background: linear-gradient(to bottom, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);">Copy</button></td> </tr> <tr class="h6-responsive"> <th scope="row">⬆️</th> <td><code>background: linear-gradient(to top, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);</code></td> <td><button type="button" class="btn btn-primary shadow-medium " data-dismiss="modal" onclick="copyColor(this)" data-toggle="tooltip" title="Click to copy" data-clipboard-text="background: linear-gradient(to top, {{$gradient->color_1}}, {{$gradient->color_2}}@if($gradient->color_3), {{$gradient->color_3}}@endif);">Copy</button></td> </tr> </tbody> </table> </div> </div> <div class="modal-footer"> <button type="button" class="btn btn-secondary shadow-medium " data-dismiss="modal">Close</button> </div> </div> </div></div>
</div>
@endsection
@section('scripts')
