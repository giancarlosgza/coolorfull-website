...
<div class="container btn-return">
    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-link ripple ripple-dark" href="/gradients/catalog"><i class="material-icons">arrow_back</i> Go back</a>
            <br>
        </div>
    </div>
</div>
<ul class="nav justify-content-center">
    <li class="nav-item">
        <a class="nav-link btn btn-outline ripple ripple-dark" onclick="copyColor()" data-toggle="tooltip" title="Click to copy"
    ...
    <div class="row mb-3">
        <div class="col-sm-12 col-md-12">
            <div class="card card-outline">
                <div class="card-body">
                   <h4 class="text-center text-poppins text-uppercase">{{$gradient->name}}</h4>
...
<div class="container">
    ...
    <h4 class="font-weight-bold">Preview UI Components</h4>
    ...
    <div class="card card-outline mb-4">
        <div class="card-body">  
            ...
            <div class="row"> <div class="col-sm-12 col-md-6"><br> <h4>Buttons</h4> <div class="btn btn-outline-light btn-sm @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> <div class="btn btn-outline-light @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> <div class="btn btn-outline-light btn-lg @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</div> </div> <div class="col-sm-12 col-md-6"><br> <h4>Badges</h4> <span class="badge badge-light uppercase @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</span> <span class="badge badge-dark uppercase @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif">{{$gradient->name}}</span> </div> <div class="col-sm-12 col-md-6"><br> <h4>Navbar black text</h4> <nav class="navbar navbar-expand-lg navbar-dark @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <a class="navbar-brand text-dark text-poppins">Colorffy</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav2" aria-controls="navbarNav2" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarNav2"> <ul class="navbar-nav"> <li class="nav-item"> <a class="nav-link text-dark">Home</a> </li> <li class="nav-item"> <a class="nav-link text-dark">Gradients</a> </li> </ul> </div> </nav> </div> <div class="col-sm-12 col-md-6"><br> <h4>Navbar white text</h4> <nav class="navbar navbar-expand-lg navbar-dark bg-dark @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <a class="navbar-brand text-white logo">Colorffy</a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav3" aria-controls="navbarNav3" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button> <div class="collapse navbar-collapse" id="navbarNav3"> <ul class="navbar-nav"> <li class="nav-item"> <a class="nav-link">Home</a> </li> <li class="nav-item"> <a class="nav-link">Gradients</a> </li> </ul> </div> </nav> </div></div><div class="row"> <div class="col-sm-12 col-md-6"><br> <h4>Card black text</h4> <div class="card text-body shadow-medium @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <div class="card-body"> <h4 class="card-title text-dark"><i class="far fa-clock"></i> 9:30 AM</h4> <p class="card-text bold text-dark">Work Meeting</p> </div> </div> </div> <div class="col-sm-12 col-md-6"><br> <h4>Card white text</h4> <div class="card text-white shadow-medium @if($gradient->color_3) bg-3-gradient @else bg-gradient @endif"> <div class="card-body"> <h4 class="card-title"><i class="far fa-clock"></i> 6:30 PM</h4> <p class="card-text bold">Pizza time!</p> </div> </div> </div></div>
            </div>
        </div>
    </div>
    ...
    <div class="card card-outline">
        <div class="card-body">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"> <li class="nav-item"> <a class="nav-link active" id="pills-color1-tab" data-toggle="pill" href="#pills-color1" role="tab" aria-controls="pills-color1" aria-selected="true">{{$gradient->color_1}}</a> </li> <li class="nav-item"> <a class="nav-link" id="pills-color2-tab" data-toggle="pill" href="#pills-color2" role="tab" aria-controls="pills-color2" aria-selected="false">{{$gradient->color_2}}</a> </li> @if($gradient->color_3) <li class="nav-item"> <a class="nav-link" id="pills-color3-tab" data-toggle="pill" href="#pills-color3" role="tab" aria-controls="pills-color3" aria-selected="false">{{$gradient->color_3}}</a> </li> @endif</ul><div class="tab-content" id="pills-tabContent"> <div class="tab-pane fade show active" id="pills-color1" role="tabpanel" aria-labelledby="pills-color1-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"></div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-1"> </div> </div> </section> </div> </div> </div> <div class="tab-pane fade" id="pills-color2" role="tabpanel" aria-labelledby="pills-color2-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-2"> </div> </div> </section> </div> </div> </div> @if($gradient->color_3) <div class="tab-pane fade" id="pills-color3" role="tabpanel" aria-labelledby="pills-color3-tab"> <div class="row"> <div class="col-6 col-md-3 col-lg-2"> <section> <h6>Normal</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanopia"> <h6>Protanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="protanomaly"> <h6>Protanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranopia"> <h6>Deuteranopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="deuteranomaly"> <h6>Deuteranomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanopia"> <h6>Tritanopia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="tritanomaly"> <h6>Tritanomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatopsia"> <h6>Achromatopsia</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> <div class="col-6 col-md-3 col-lg-2"> <section class="achromatomaly"> <h6>Achromatomaly</h6> <div class="card box-shadow-0 mb-2"> <div class="card-body bg-3"> </div> </div> </section> </div> </div> </div> @endif</div>
            </div>    
        </div>
    </div>
