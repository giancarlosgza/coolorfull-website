...
<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <h3 class="text-montserrat text-indigo">Colorffy Design System</h3><br>
        </div>
        <div class=" col-12 col-sm-6">
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" href="#"><i class="fas fa-lock"></i> Material White (Soon)</a>
                    <!-- 
        ...
        <div class="col-12 col-sm-6">
            ...
            <a href="/design/system/docs" class="btn btn-light shadow-medium text-right small align-self-end">
...
<div class="container container-material" id="material-gradient">
    <div class="row">
        <div class="col-sm-12">
            <h3 class="logo text-indigo">Material Gradient</h3>
            <h5 class="text-montserrat">Components</h5><hr>
            <!--COLORS MATERIAL GRADIENT-->
            <h5 class="text-montserrat">Colors</h5>
            <div class="row">
                <div class="col-md-3">
            ...
            <h5 class="text-montserrat">Alerts</h5>
        ...
        <div class="col-sm-12">
            ...
            <h5 class="text-montserrat">Badges</h5>
        ...
        <div class="col-md-12">
            <hr>
            <!--BREADCRUMB-->
            <h5 class="text-montserrat">Breadcrumb</h5>    
        ...
        <div class="col-sm-12">
            <hr>
            <!--BUTTONS-->
            <h5 class="text-montserrat">Buttons</h5>
            <h6>Normal</h6>
        ...
        <div class="col-sm-12">
            <hr>
            <!--CARDS-->
            <h5 class="text-montserrat">Cards</h5>
        </div>
        ...
        <div class="col-sm-12">
            <hr>
            <!--LIST GROUP-->
            <h5 class="text-montserrat">List Group</h5>
        ...
        <div class="col-sm-12">
            <hr>
            <!--MODAL-->
            <h5 class="text-montserrat">Modal</h5>
        ...
        <div class="col-sm-12">
            <hr>
            <!--NAVBAR-->
            <h5 class="text-montserrat">Navbar</h5>
        ...
        <div class="col-sm-12">
            <hr>
            <!--PROGRESS-->
            <h5 class="text-montserrat">Progress</h5>
            <div class="progress">
        ...
        <div class="col-sm-12">
            <hr>
            <!--FORM-->
            <h5 class="text-montserrat">Form</h5>
            <div class="card card-mat-g">
                <div class="card-body">
                    <h5>Register</h5><hr>
                    <form>
