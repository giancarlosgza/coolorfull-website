                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="email"><i class="material-icons">person</i>
                                        ...
                                        <div class="form-group">
                                            <label for="password"><i class="material-icons">lock</i>    
                                                {{ __('Password') }}</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-link ripple ripple-dark" href="{{ route('password.request') }}">
                                                {{ __('Forgot Your Password?') }}
                                            </a>
                                            @endif
                                            <hr>
                                            <a class="btn btn-link ripple ripple-dark" href="/register">Create your account!</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
